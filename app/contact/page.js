    ...
    <main className="bg-slate-50">
      ...
      <section className="mx-auto max-w-7xl px-6 py-16">
        <SectionTitle
          ...
          subtitle="The details below are pulled from MongoDB, so when the admin dashboard is updated the site reflects it immediately after revalidation."
          align="left"
        />
          ...
          <div className="overflow-hidden rounded-[2rem] border border-slate-200 bg-slate-950 text-white shadow-[0_18px_50px_rgba(15,23,42,0.08)]">
            ...
            <div className="space-y-4 p-6">
              ...
              <DetailRow
                icon={FaEnvelope}
                label="Email"
                value={contact.email || "info@ndo.com"}
                href={`mailto:${contact.email || "info@ndo.com"}`}
              />
              <DetailRow
                icon={FaPhoneAlt}
                label="Phone"
